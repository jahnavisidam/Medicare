    ...
    <div className='flex flex-col lg:flex-row gap[90px] items-center justify-between'>
      ...
      <div>
        <div className='lg:w-[570px]'>
          ...
          <p className='text_para'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit ex amet deleniti enim quis voluptatem quae dolorum! Autem est alias, odio esse quo quia ipsa dolorum, quas, placeat distinctio pariatur.</p>
    ...
    <section>
      <div className='container'>
        <div className='lg:w-[470px] mx-auto'>
          <h2 className='heading text-center'>Proividing the best medical services</h2>
        ...
        <div className="flex items-center justify-between flex-col lg:flex-row">
         ...
         <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
          ...
          <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
            ...
            <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 llg:mt-4 rounded-full'>
             Consultation
            </div>
